...
update_directory(const char* path, const char* unmount_when_done) {
    ...
    const char* MENU_HEADERS[] = { "请选择一个要包装的包:",
                                   path,
                                   "",
                                   NULL };
    DIR* d;
...
show_3dtools_menu()
{
    static char* headers[] = {  "3D工具箱",
                                "",
                                NULL
    };
    static char* list[] = { "备份基带",
                            "恢复基带",
                            "关于",
                            NULL
    };
    ...
    for (;;)
    {
        ...
        {
            case 0:
                 ui_print("lovest3d:正在努力备份，请稍等...\n");
                 __system("mount /sdcard");
                 __system("mkdir /sdcard/secro");
                 __system("dd if=/dev/block/mmcblk0p4 of=/sdcard/secro/secro.img");
                 __system("umount /sdcard");
                 ui_print("lovest3d:备份完成！\n");
                break;
            case 1:
                 ui_print("lovest3d:正在恢复...\n");
                 __system("mount /sdcard");
                 __system("dd if=/sdcard/secro/secro.img of=/dev/block/mmcblk0p4");
                 __system("umount /sdcard");
                 ui_print("lovest3d:恢复完成！\n");
                break;
            case 2:
                ui_print(" \n");
                ui_print("作|Author information\n");
                ui_print("者|ID：lovest3d\n");
                ui_print("信|安智ATX破晓组成员\n");
                ui_print("息|微博http：//weibo.com/lovest3d\n");
                break;
        }
    }
...
main(int argc, char **argv) {
    ...
    ui_init();
    //下排名称打印ui_print(EXPAND(RECOVERY_VERSION)"\n");
    load_volume_table();
    process_volumes();
